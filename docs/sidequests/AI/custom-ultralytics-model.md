...
Dette er et videregående sidequest. Du bør kunne skrive enkel Python, bruke GitHub og forklare forskjellen på treningsdata og testdata. Start gjerne med [introduksjonsoppdraget](ultralytics-computer-vision.md) først.
